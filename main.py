...
parser.add_argument('--epoch', default = 24, type = int) # small values for debug
...
parser.add_argument('--distill_temperature', default = 4, type = float)
...
if __name__ == "__main__":
    ...
    trainer.train(args.batch_size, args.epoch, args.lr, args.bias_lr, args.max_size, T = args.distill_temperature, beta = args.beta)
