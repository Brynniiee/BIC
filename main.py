...
parser.add_argument('--epoch', default = 125, type = int) 
parser.add_argument('--lr', default = 0.001, type = float) 
parser.add_argument('--max_size', default = 400, type = int)
parser.add_argument('--init_cls', default = 0, type = int)  
...
if __name__ == "__main__":
    ...
    trainer.train(args.batch_size, args.epoch, args.lr, args.bias_lr, args.max_size, T = args.distill_temperature)
