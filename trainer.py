...
class Trainer:
    ...
    def train(self, batch_size, epoches, lr, max_size):
        ...
        self.trainer_visual(val_acc_noBiC, val_acc, test_accs, test_accs_noBiC)

        
    def trainer_visual(self, val_acc_noBiC, val_acc, test_accs, test_accs_noBiC):
        ...
        for i in range(len(val_acc_noBiC)):
            ...
            plt.plot(epochs, val_acc_noBiC[i], label=f"Task {i}")  
        plt.xlabel("Epochs")
        plt.ylabel("Accuracy/%")
        ...
        for i in range(len(val_acc)):
            ...
            plt.plot(epochs , val_acc[i], label=f"Task {i}")  
        ...
        for i in range(len(test_accs_noBiC)):
            ...
            plt.plot(tasks, test_accs_noBiC, label=f"Task {i}")
            plt.plot(test_accs, label=f"Task {i} with BiC")
